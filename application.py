...
API_URL = "http://localhost:7860/process"  # Use the Docker-exposed port
            ...
            try:
                ...
                if response.status_code == 200:
                    ...
                    if audio_url:
                        ...
                        audio_url_absolute = f"http://localhost:7860{audio_url}"
                        # audio_url_absolute = f"http://127.0.0.1:8000{audio_url}"
